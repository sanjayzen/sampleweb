...
public class Bookmark extends PdfPageEventHelper {
		...
		public static void main(String[] args) {
			...
			try {
				...
				// step 2:
				PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("E:/reports/Bookmarks.pdf"));
				// step 3:
		           writer.setViewerPreferences(PdfWriter.PageModeUseOutlines);
				document.open();
		           // step 4: we grab the ContentByte and do some stuff with it
		           writer.setPageEvent(new Bookmark());
